        ...
        <div className='flex-1 max-w-md'>
         <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
          ...
          <div className='grid grid-cols-2 gap-4'>
            ...
            <InputField handleChange={handleChange} address={address} name='country' type="text" placeholder="Contry"/>
          </div>

          <InputField handleChange={handleChange} address={address} name='phone' type="number" placeholder="Phone"/>
         
         <button on className='w-full mt-6 bg-primary text-white py-3 hover:bg-primary-dull trasition curser-pointer uppercase'>Save address</button>
